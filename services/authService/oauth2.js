module.exports = function(dbService, db) {
    ...
    server.grant(oauth2orize.grant.code(function(client, redirectURI, user, ares, done) {
        ...
        db.authorizationCodes.save(code, client._id, client.redirectURI, user._id, function(err) {
            if (err) {
                return done(err);
            }
            done(null, code);
    ...
    returnObj.authorization = [
        ensureLoggedIn('/login'), server.authorization(function(clientID, redirectURI, done) {
    ...
    // a response.
    returnObj.decision = [
        ensureLoggedIn('/login'), server.decision()
    ];
