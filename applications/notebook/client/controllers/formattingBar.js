$(document).ready(function() {
    //Fill the dropdown with all the font sizes
    populateFonSizes();
    ...
    $( ".fontPanelFontSizeSelect" ).change(function() {
        ...
        $("." + randomCssClass).css({"font-size": $(".fontPanelFontSizeSelect").val() + "pt", "line-height": $(".fontPanelFontSizeSelect").val() + "pt"}).removeClass(randomCssClass);
    });
